...
<body>
    <header class="d-flex justify-content-between align-items-center py-3">
        <div class="d-flex align-items-center">
            <a href="DashboardStudent.html" class="btn"> 
                <img src="logo e imgs/logoPlacerHolder.png" alt="Logo" width="40" height="40"></img> 
            </a>  
            <div class="dropdown">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                    ...
                    <li><a class="dropdown-item" href="Kardex.html">Kardex</a></li>
                    <li><a class="dropdown-item" href="Mensajeria.html">Mensajes</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="SignUp.html">Cerrar Sesión</a></li>
                </ul>
            </div>
        </div>
        <!-- Ventana Modal -->
