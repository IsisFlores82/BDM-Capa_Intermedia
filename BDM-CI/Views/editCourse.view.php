        ...
        <div class="col-xl-5 mb-5">
          <div class="p-3 bg-body-secondary rounded">
            ...
            <div class="form-check d-flex align-items-center">
              <input type="checkbox" name="Gratuito" class="form-check-input me-2" value="0" id="isFree" <?= $course['Gratuito'] == 0 ? 'checked' : ''; ?>>
                    ...
                    <div class="row g-0">
                      <div class="col-md-4">
                        ...
                        <div class="mt-3 form-check px-1">
                          ...
                          <input class="form-check-input me-2 level-free-checkbox" type="checkbox" value="0" id="flexCheckChecked-${index}" name="Nivel[${index}][Gratuito]" <?= $level['Costo_Nivel'] == '0.00' ? 'checked' : '' ?> data-bs-toggle="tooltip" title="En caso de no estar activo, el nivel será gratuito">                            <div class="input-group" style="max-width: 240px;">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          <div class="row align-items-center">
                            ...
                            <!-- Botón de eliminar nivel -->
                            <button class="col-2 btn btn-outline-danger align-self-start mb-3 removeCardBtn" type="button" onclick="removeLevel(${index})"> <i class="fa-solid fa-trash"></i> Eliminar Nivel</button>
                          </div>
  ...
  <script>
    $(document).ready(function() {
      $('#addLevelBtn').click(function() {
        // Code to dynamically add new levels (similar to your "Crear Curso" view)
      });

      $('.removeLevelBtn').click(function() {
        const levelCard = $(this).closest('.level-card');
        const levelId = $(this).data('level-id');
        
        // Mark level as "to be deleted" (use hidden input or flag)
        levelCard.append('<input type="hidden" name="NivelEliminar[]" value="' + levelId + '">');
        levelCard.hide();  // Hide the level from view
      });
    });
